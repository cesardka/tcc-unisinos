...
\begin{enumerate}
    ...
    \item \textbf{Experiência com cardápio digital via QR Code} (utilidade percebida, facilidade de uso, motivação hedônica, comparação com cardápio físico, situações de fricção);
